...
def send_alert_email(subject, body):
    sender_email = "motheeshadusumilli11@gmail.com"  # Replace with your email
    email_password = "Moonlight@2004"  # Replace with your email password
    receiver_email = "motheeshadusumilli@gmail.com"  # Replace with recipient email
